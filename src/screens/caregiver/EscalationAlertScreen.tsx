  ...
  return (
    <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container}>
      ...
      {alerts.map((alert) => (
        <Card
          key={alert.id}
          bgColor={alert.resolved ? COLORS.surfaceElevated : COLORS.errorLight}
      ...
      <Card bgColor={COLORS.surfaceElevated} borderColor={COLORS.mintGreenDark} style={styles.ardsiCard}>
